...
function startGame(){
    ...
    function compare(x,y){
        if(x===y){
            ...
            newhead1.classList.add('heading1');
            newhead1.innerHTML="Too low! Guess again Bruh!";
        }
        else if (x > y){
            newhead1.classList.add('heading1');
            newhead1.innerHTML="Too high! Guess again Bruh!";
        }
    }

    function limitnum(){
        newhead1.classList.add('heading1');
        newhead1.innerHTML="Bruh you couldn't guess bro!!! The real number was " + `${random}`;
        inputBox.setAttribute('disabled', '');
        newgame.classList.add('heading1');
        newgame.innerHTML="Start New Game!";
    }
